...
const CreateWallet = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-70px)] bg-background bg-[linear-gradient(to_right,#80808033_1px,transparent_1px),linear-gradient(to_bottom,#80808033_1px,transparent_1px)] bg-size-[70px_70px] px-5 pt-[70px] prose-h4:xl:text-2xl prose-h4:lg:text-xl prose-h4:text-lg">
      ...
      <div className="mx-auto max-w-[900px] my-16 px-6 flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="font-body text-base w500:text-lg w400:text-base text-gray-600 dark:text-gray-400">
            {wallets.length > 0
              ? "Create a new wallet to store your crypto assets."
